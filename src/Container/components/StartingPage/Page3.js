        ...
        <div style={{minHeight:"100vh"}}>
            <div className=" bg-green-light ">
                ...
                <div className="mx-8 flex justify-center items-center" >
                    <img src="./image/easySopping.png" alt="error" className="h-80" />
                </div>
            </div>
            <div className="grid  grid-cols-6">

                <div className="col-start-1 col-span-6 sm:col-start-2 sm:col-span-4 lg:col-start-3 lg:col-span-2">
                    <p className="text-center mt-8 font-Nunito text-2xl text-black-deep">Easy Shopping</p>
                    <p className="text-center mt-4 font-Nunito text-base text-black-light mx-3.5 ">Grab your items only need to order from home, click pay and wait for the courier to arrive</p>
